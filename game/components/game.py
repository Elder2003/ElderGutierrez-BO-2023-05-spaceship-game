import pygame
from game.utils.constants import START_BACKROUND,BG, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, TITLE, FPS, FONT_STYLE, DEFAULT_TYPE
...
class Game:
    ...
    def update(self):
        ...
        if self.player.has_power_up and current_time - self.player.power_up_time_up >= 10000:
